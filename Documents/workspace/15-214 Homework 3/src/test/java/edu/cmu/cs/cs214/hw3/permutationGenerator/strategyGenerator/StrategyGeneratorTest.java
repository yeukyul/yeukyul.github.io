...
/**
 * This test unit tests the implementation of a StrategyGenerator.
 * 
 * @author yeukyulee
 *
 */
public class StrategyGeneratorTest<E> {
  ...
  StrategyGenerator<E> intGenerator0;
  StrategyGenerator<E> intGenerator1;
  StrategyGenerator<E> intGenerator2;
  StrategyGenerator<E> intGenerator3;
  StrategyGenerator<E> intGenerator4;
  ...
  /* Generators for corresponding arrayList */
  StrategyGenerator<E> stringGenerator0;
  StrategyGenerator<E> stringGenerator1;
  StrategyGenerator<E> stringGenerator2;
  StrategyGenerator<E> stringGenerator3;
  StrategyGenerator<E> stringGenerator4;

  /**
   * Constructor method for Strategy Generator Test. Initialize common structure
   * in this test unit. Since these structures will not be modified, setting up
   * once will suffice for all future tests.
   */
  public StrategyGeneratorTest() {
    ...
    intGenerator0 = (StrategyGenerator<E>) new StrategyGenerator<Integer>(testIntList0);
    intGenerator1 = (StrategyGenerator<E>) new StrategyGenerator<Integer>(testIntList1);
    intGenerator2 = (StrategyGenerator<E>) new StrategyGenerator<Integer>(testIntList2);
    intGenerator3 = (StrategyGenerator<E>) new StrategyGenerator<Integer>(testIntList3);
    intGenerator4 = (StrategyGenerator<E>) new StrategyGenerator<Integer>(testIntList4);
    ...
    // initialize generators
    stringGenerator0 = (StrategyGenerator<E>) new StrategyGenerator<String>(testStringList0);
    stringGenerator1 = (StrategyGenerator<E>) new StrategyGenerator<String>(testStringList1);
    stringGenerator2 = (StrategyGenerator<E>) new StrategyGenerator<String>(testStringList2);
    stringGenerator3 = (StrategyGenerator<E>) new StrategyGenerator<String>(testStringList3);
    stringGenerator4 = (StrategyGenerator<E>) new StrategyGenerator<String>(testStringList4);
  }
   ...
   */
  private String[] getAllPermutations(StrategyGenerator<E> generator) {
