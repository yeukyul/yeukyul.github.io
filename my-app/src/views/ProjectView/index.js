        ...
        <>
            {/* <Animated animationInDuration={2000} isVisible={true}> */}
                ...
                <ProjectHeadline 
                    ...
                    type="hardware">
                    <div width="500">
                        <iframe width="500" height="315" src="https://www.youtube.com/embed/yeQi-s0GgDw" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </ProjectHeadline>
                {/* Lindia */}
                <ProjectHeadline
